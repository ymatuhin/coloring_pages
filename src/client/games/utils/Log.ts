...
export namespace Log {
    ...
    // current mode
    let mode: string = MODE_DEBUG;
    // available levels
    let levels: Array<string> = [DEBUG, INFO, NETWORK, WARNING, ERROR];
    ...
    function log(aMsg: any, aLevel: string = DEBUG) {
    ...
    export function debug(aMsg: any) {
        log(aMsg, DEBUG);
    }

    export function info(aMsg: any) {
        log(aMsg, INFO);
    }

    export function net(aMsg: any) {
        log(aMsg, NETWORK);
    }

    export function warn(aMsg: any) {
        log(aMsg, WARNING);
    }

    export function error(aMsg: any) {
        log(aMsg, ERROR);
    }
